...
while (anoAtual < anoFinal or (anoAtual == anoFinal and mesAtual <= mesFinal ) ):
	download_url = "http://www.portaldatransparencia.gov.br/download-de-dados/licitacoes/{}{:02}".format(anoAtual, mesAtual)
	print("Downloading {}{:02}".format(anoAtual, mesAtual))
	nome_do_arquivo = "dados/{}{:02}.zip".format(anoAtual, mesAtual)
